...
<h1 className="font-headline text-6xl md:text-8xl font-extrabold tracking-tighter leading-[0.9] mb-6">
                    RAFA <br/> <span className="text-primary">AGUIRRE</span>
</h1>
<p className="font-headline text-2xl md:text-3xl font-bold text-on-surface-variant mb-8 max-w-xl">
...
<div className="p-8">
<span className="font-label text-[10px] uppercase tracking-widest text-primary font-black mb-3 block">{project.category}</span>
